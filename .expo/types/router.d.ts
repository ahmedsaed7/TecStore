...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(drawer)/(tabs)/favorite` | `/favorite` | `/(drawer)/(tabs)/Home` | `/Home` | `/(drawer)/(tabs)/profile` | `/profile` | `/(drawer)/settings` | `/settings` | `/(tabadmin)/Products` | `/Products` | `/(tabadmin)/profile` | `/(tabadmin)/Sells` | `/Sells` | `/(tabadmin)/Users` | `/Users` | `/admins/addProduct` | `/admins/editProduct` | `/card` | `/categories` | `/CheckOut` | `/forgotPassword` | `/isFirstTime` | `/Item` | `/login` | `/pressedItem` | `/signup` | `/slider` | `/welcome`;
  // prettier-ignore
